...
def write_marks_to_excel(output_sheet, column_name):
...
def write_hobbies_to_excel(output_sheet, column_name):
...
def write_cities_visited_to_excel(output_sheet, column_name):
    """Function to write the cities of a PS number to the excel file"""
    row_num = 2
    for city in cities_visited_list:
        cell_pos = column_name + str(row_num)
...
def write_programming_skills_to_excel(output_sheet, column_name):
    """Function to write the programming skills of a PS number to the excel file"""
    row_num = 2
    for programming_skill in programming_skills_list:
        cell_pos = column_name + str(row_num)
...
def write_domain_areas_to_excel(output_sheet, column_name):
    """Function to write the domain areas of a PS number to the excel file"""
    row_num = 2
    for domain_area in domain_ares_list:
        cell_pos = column_name + str(row_num)
...
if __name__ == '__main__':
    ...
    write_marks_to_excel(sheet, "A")
    write_hobbies_to_excel(sheet, "B")
    write_cities_visited_to_excel(sheet, "C")
    write_programming_skills_to_excel(sheet, "D")
    write_domain_areas_to_excel(sheet, "E")
    output_workbook.save(f"{ps_num}_output_data.xlsx")
