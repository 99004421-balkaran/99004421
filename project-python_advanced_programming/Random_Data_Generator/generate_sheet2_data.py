...
class SheetNumberTwo:
    ...
    def __init__(self, list_ps_numbers, sheet_obj, workbook_obj):
        ...
        self.random_hobbies = ["Acting", "Animation", "Art", "Baking", "Basketball", "Beat boxing",
                               ...
                               "Candy making", "Card games", "Ceramics", "Chatting",
    ...
    def write_to_excel_file(self):
        ...
        for num in range(1, 21):
            cell_pos = chr(col) + '1'
            self.sheet_obj[cell_pos] = "Hobby " + str(num)
            col += 1
        index_of_ps = 0
        col = 65
        ...
        for row in range(2, 17):
            ...
            for col in range(66, (66 + 20)):
                cell_pos = chr(col) + str(row)
                self.sheet_obj[cell_pos] = self.hobbies_list[list_row][list_col]
                list_col += 1
            list_row += 1
